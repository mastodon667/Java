...
import observer.PropagationDialogObservable;
import data.Course;
...
public class PropagationDialog extends JDialog implements ActionListener {
	...
	private PropagationDialogObservable observable;
	...
	public PropagationDialog(JFrame parent, Observer o, ArrayList<Course> before, ArrayList<Course> after) {
		...
		observable = new PropagationDialogObservable();
		...
		JLabel lblDescription = new JLabel("De nieuwe keuze heeft ervoor gezorgd dat onderstaande propagaties niet meer van kracht zijn. \n"
				+ "Gelieve te selecteren welke van deze propagaties je wenst te behouden.");
